...
class AddUserView extends StatelessWidget {
  ...
  Widget _crearCirculo(String image) {    
    ...
    _crearBotonRegistrarme(LoginBloc bloc) {
      return StreamBuilder(
  ...
  _register(LoginBloc bloc, BuildContext context) async {
    ...
    final resp = await provider.register(model);

    if (resp == 'success'){
      _showToast(context, 'Te has registrado correctamente.');
      Navigator.pop(context);
    } 
    else {
      _showToast(context, resp);
    }
